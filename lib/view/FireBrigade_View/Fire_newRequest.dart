...
typedef FireBrigadeDataCallback = Function(
    String option, String id, GeoPoint location);

// ignore: must_be_immutable
class FireNewRequests extends StatelessWidget {
  FireNewRequests({super.key});
                      ...
                      Row(
                        children: [
                          ...
                          GetAvailableStaff(
                            ...
                            departmentCategory: 'FireBrigade Department',
                          ),
                        ],
                      ),
                      ...
                      ElevatedButton(
                          onPressed: () {
                            if (selectedOption != null) {
                              ...
                              if (staffUID != null) {
                                final fireBrigadeAllocationData =
                                    FireBrigade_model(
                                        status: 'In Progress',
                                        caseID: newRequests[index]['caseID'],
                                        allotedAt: allotedAt,
                                        fireBrigadeAllotedId: staffUID!,
                                        fireBrigadeLocation: staffLocation!,
                                        fireBrigadeServiceAlloted: true,
                                        responseMessage:
                                            responseMessageController.text);
                                MyCloudStoreBase obj = MyCloudStore();
                                obj
                                    .allocateFireBrigadeStaff(
                                        newRequests[index]['documentID'],
                                        fireBrigadeAllocationData)
                                    .onError((error, stackTrace) =>
                                        Message.flutterToast(
                                            context, "Error: Assigning Staff "))
